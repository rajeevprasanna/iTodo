...
@interface iValidationViewController ()

@end

@implementation iValidationViewController
@synthesize username;
@synthesize password;
@synthesize email;
...
-(void)move{
    iHomepageViewController *ih=[self.storyboard instantiateViewControllerWithIdentifier:@"iTestViewController"];
